# Test simple de connexion de la voiture noire (client) vers la voiture rose (serveur)
# Montre simplement le fonctionnement de la connexion entre les deux voitures
